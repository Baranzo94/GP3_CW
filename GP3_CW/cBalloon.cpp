...
=================
*/
void cBalloon::update(float deltaTime) 					// update the ships position based on the translation
{
	D3DXVECTOR2 tempV2;
	D3DXVECTOR3 tempV3;
...
=================
*/
eDirection cBalloon::getDirection()       // Returns the current direction of the sprite
{
